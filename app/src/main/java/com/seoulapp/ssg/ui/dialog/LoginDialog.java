...
public class LoginDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mTitleView = (TextView) v.findViewById(R.id.edit_title);
        mEmail = String.valueOf((TextView) v.findViewById(R.id.edit_email));
        mButton = (Button) v.findViewById(R.id.edit_login);
        ...
        Log.e(TAG, "onCreateView: " +  mProfile);
